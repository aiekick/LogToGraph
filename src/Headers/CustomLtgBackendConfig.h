...
#define STROCKER_BRIDGE_ICON_LABEL_RESET ICON_SDFM_TRASH_CAN_OUTLINE
#define STROCKER_BRIDGE_ICON_LABEL_PAUSE ICON_SDFM_PAUSE
#define STROCKER_BRIDGE_ICON_LABEL_PLAY ICON_SDFM_PLAY
#define STROCKER_BRIDGE_ICON_LABEL_EDIT ICON_SDFM_PENCIL
#define STROCKER_BRIDGE_CAMERA_ICON_LABEL_LOCK ICON_SDFM_LOCK
