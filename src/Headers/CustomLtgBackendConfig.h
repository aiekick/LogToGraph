...
#define LOG_TO_GRAPH_BRIDGE_ICON_LABEL_RESET ICON_SDFM_TRASH_CAN_OUTLINE
#define LOG_TO_GRAPH_BRIDGE_ICON_LABEL_PAUSE ICON_SDFM_PAUSE
#define LOG_TO_GRAPH_BRIDGE_ICON_LABEL_PLAY ICON_SDFM_PLAY
#define LOG_TO_GRAPH_BRIDGE_ICON_LABEL_EDIT ICON_SDFM_PENCIL
