...
#define LOG_TO_GRAPH_BRIDGE_ICON_LABEL_RESET ICON_FONT_TRASH_CAN_OUTLINE
#define LOG_TO_GRAPH_BRIDGE_ICON_LABEL_PAUSE ICON_FONT_PAUSE
#define LOG_TO_GRAPH_BRIDGE_ICON_LABEL_PLAY ICON_FONT_PLAY
#define LOG_TO_GRAPH_BRIDGE_ICON_LABEL_EDIT ICON_FONT_PENCIL
#define LOG_TO_GRAPH_BRIDGE_CAMERA_ICON_LABEL_LOCK ICON_FONT_LOCK
