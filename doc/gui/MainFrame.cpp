...
{
	if (ImGui::BeginMenu(ICON_FONT_DOT_CIRCLE_O " Project"))
	{
		...
		if (ProjectFile::Instance()->IsLoaded())
		{
			...
			if (ImGui::MenuItem(ICON_FONT_FLOPPY_O " Save"))
			{
				Action_Menu_SaveProject();
			}

			if (ImGui::MenuItem(ICON_FONT_FLOPPY_O " Save As"))
			{
			...
			if (ImGui::MenuItem(ICON_FONT_CANCEL " Close"))
			{
		...
		if (ImGui::MenuItem(ICON_FONT_EXCLAMATION_CIRCLE " About"))
		{
	...
	if (ImGui::BeginMenu(ICON_FONT_COG " Settings"))
	{
		if (ImGui::BeginMenu(ICON_FONT_PENCIL_SQUARE " Styles"))
		{
